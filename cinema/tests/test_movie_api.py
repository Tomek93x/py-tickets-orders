...
class MovieApiTests(TestCase):
    ...
    def test_post_movies(self):
        ...
        print("POST superman content: ", movies.content)
    ...
    def test_post_invalid_movies(self):
        movies = self.client.post(
            "/api/cinema/movies/",
            {
                ...
                "description": "Superman description",
                "duration": 123,
                # błędny format, actors jako dict zamiast listy ID
                "actors": [{"id": 3}],
            },
            format="json"
        )
        print("POST invalid movies content: ", movies.content)
